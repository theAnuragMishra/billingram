    ...
    while True:
        try:
            ...
            if cn.is_connected():
                ...
                cursor.execute("create table if not exists Invoice_List(Invoice_ID varchar(20) PRIMARY KEY NOT NULL,Customer_ID varchar(15) NOT NULL,Date_of_Billing date NOT NULL,Customer_Name varchar(50) NOT NULL,Mobile_Number char(10) NOT NULL,No_of_Items integer NOT NULL,Total_Amount decimal(64,2) NOT NULL)")
